...
import { View, Text, StyleSheet, TextInput, TouchableOpacity, ScrollView, Image, Switch, SafeAreaView } from 'react-native';
import { Stack, useRouter } from 'expo-router';
import { Camera, Plus, Edit, Send, UserPlus, ChevronRight, X } from 'lucide-react-native';
        ...
        options={{
          headerTitle: () => (
            <View>
              ...
              <Text style={styles.navSubtitle}>Add subject</Text>
            </View>
          ),
          headerRight: () => (
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <View style={styles.membersHeader}>
            <Text style={styles.sectionHeader}>Members ({dummyMembers.length})</Text>
            <TouchableOpacity>
            ...
            {dummyMembers.map(member => (
              <View key={member.id} style={styles.memberItem}>
                <View style={styles.memberAvatarContainer}>
                  ...
                  <TouchableOpacity style={styles.removeMemberBtn}>
